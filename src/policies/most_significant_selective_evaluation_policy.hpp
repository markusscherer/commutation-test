...
#include "selective_evaluation_policy.hpp"

template <uint64_t D, uint64_t A, class ElementType>
struct most_significant_selective_evaluation_policy {};

template <class ElementType>
struct most_significant_selective_evaluation_policy<4, 4, ElementType> {
...
template <uint64_t D, uint64_t A, class ElementType>
struct most_significant_selective_transposed_evaluation_policy {};

template <class ElementType>
struct most_significant_selective_transposed_evaluation_policy<4, 4,
           ElementType> {
    typedef simd_evaluation_constants<4, 4> constants;
    typedef simd_evaluation_registers<4, 4> registers;
